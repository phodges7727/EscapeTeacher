...
public class GameGUI extends JComponent
{
  ...
  public GameGUI()
  {
    ...
    // player image, student can customzie this image by changing file on disk
    try {
  ...
  * Note that traps and prizes may occupy the same locaiton.
  */
   ...
   * postcondition: increases number of steps even if the player did not actually move (e.g. bumbing into a wall)
   * <P>
   * @param incrx amount to move player in x direction
   * @param incry amount to move player in y direciton
   * @return penaly score for hitting a wall or potentially going off the grid, 0 otherwise
   */
   ...
   * <P>
   * precondition: newx and newy must be the amount a player regulary moves, otherwise an existing trap may go undetected
   * <P>
   * @param newx a location indicating the space to the right or left of the player
   * @param newy a location inidicatin the space above or below the player
   * @return true if the new locaiton has a trap that has not been sprung, false otherwise
   */
  ...
  /**
   * Spring the trap. Traps can only be sprung once and attemps to spring
   * a sprung task results in a penalty.
   * <P>
   * precondition: newx and newy must be the amount a player regulary moves, otherwise an existing trap may go unsprung
   * <P>
   * @param newx a location indicating the space to the right or left of the player
   * @param newy a location inidicatin the space above or below the player
   * @return a positive score if a trap is sprun, otherwise a negative penalty for trying to spring a non-existent trap
   */
   ...
   * <P>
   * precondtion p must be a positive, non-zero integer
   * <P>
   ...
   * <P>
   * precondtion t must be a positive, non-zero integer
   * <P>
